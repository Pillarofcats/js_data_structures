class MaxHeap {
  ...
  //Swap two elements with passed indexes using destructuring, this is to maintain the heap property
  ...
  maxBubbleDown() {
    ...
    while(true) {
      ...
      if(this.heap[leftChildIndex] >= this.heap[rightChildIndex] && this.heap[leftChildIndex] >= this.heap[currentIndex]) {
        ...
        console.log("left is larger: ", this.heap[leftChildIndex], "right: ", this.heap[rightChildIndex]);
        ...
        console.log("left: ", this.heap[leftChildIndex], "right is larger: ", this.heap[rightChildIndex]);
  ...
  //Convert passed initial array into a max heap
  maxHeapify(initArray) {
